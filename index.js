      ...
      functionObj.events.forEach(event => {
        if (event.sns) {
          ...
          if (typeof event.sns === 'object') {
            ...
            tags = Object.assign({}, self._serverless.${aws:accountId}.tags, event.sns.tags);
            ...
            tags = Object.assign({}, self._serverless.${aws:accountId}.tags);
            topicLogicalId = self._provider.naming.getTopicLogicalId(topicName)
            topics.push({ "logicalId": topicLogicalId, 'tags': tags });
          }
          ...
          let tags = Object.assign({}, self._serverless.${aws:accountId}.tags, event.schedule.tags);
